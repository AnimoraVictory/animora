...
const (
	// Label holds the string label denoting the blockrelation type in the database.
	Label = "block_relation"
	...
	EdgeTo = "to"
	// Table holds the table name of the blockrelation in the database.
	Table = "block_relations"
	// FromTable is the table that holds the from relation/edge.
	FromTable = "block_relations"
	...
	ToColumn = "user_blocked_by"
)

// Columns holds all SQL columns for blockrelation fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
}

// ForeignKeys holds the SQL foreign-keys that are owned by the "block_relations"
...
// OrderOption defines the ordering options for the BlockRelation queries.
